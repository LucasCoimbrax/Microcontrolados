  ...
  while (1)
{
    for(i = 0; i < 100; i++)
    {
      ...
      if(button_release(BT1_GPIO_Port, BT1_Pin, 0))
      {
        if(j<200)
        {
          j = j + 25;
          htim3.Instance->CCR2 = (htim3.Instance->ARR*j)/200;
        }
        else if (j>=200)
        {
          j = 200;
      ...
      if(button_release(BT2_GPIO_Port, BT2_Pin, 0))
      {
        if(j>0)
        {
          j = j - 25;
